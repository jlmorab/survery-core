...
Ext.onReady(function() {
    ...
    if (Ext.Date) {
        ...
        Ext.Date.dayNames = ["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado"];
    ...
    Ext.define("Ext.locale.es.form.field.Base", {
        ...
        invalidText: "El valor en este campo es invalido"
    });
    ...
    Ext.define("Ext.locale.es.form.field.Number", {
        ...
        decimalSeparator: ",",
        decimalPrecision: 2,
        minText: "El valor minimo para este campo es de {0}",
        maxText: "El valor maximo para este campo es de {0}",
        nanText: "{0} no es un numero valido"
    });
    ...
    Ext.define("Ext.locale.es.form.field.Date", {
        ...
        invalidText: "{0} no es una fecha valida - debe tener el formato {1}",
        format: "d/m/Y",
    ...
    Ext.define("Ext.locale.es.form.field.Time", {
        ...
        invalidText: "{0} no es una hora valida",
        format: "g:i A",
    ...
    Ext.define("Ext.locale.es.form.CheckboxGroup", {
        ...
        blankText: "Debe seleccionar al menos un etem de este grupo"
    });

    Ext.define("Ext.locale.es.form.RadioGroup", {
        override: "Ext.form.RadioGroup",
        blankText: "Debe seleccionar un etem de este grupo"
    });
});
