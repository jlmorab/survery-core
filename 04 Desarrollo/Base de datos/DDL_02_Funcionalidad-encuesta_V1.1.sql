...
-- Crea tabla cat_tipo_pregunta |: Catálogo de tipos de preguntas
CREATE TABLE cat_tipo_pregunta(
	i_tipo_pregunta 				TINYINT(1) 		UNSIGNED NOT NULL AUTO_INCREMENT 	COMMENT 'Id',
    i_tipo_pregunta_status 			TINYINT(1) 		UNSIGNED NOT NULL 					COMMENT 'Estatus de registro', 
    n_tipo_pregunta 				VARCHAR(50) 	COLLATE utf8_unicode_ci NOT NULL 	COMMENT 'Nombre', 
    CONSTRAINT 						PK_tipo_pregunta 
    PRIMARY 						KEY(i_tipo_pregunta), 
    CONSTRAINT 						FK_tipo_pregunta_status 
    FOREIGN 						KEY(i_tipo_pregunta_status) 
    REFERENCES 						sys_status_general(i_status_general)
) COMMENT 'Catálogo de tipos de preguntas' 
ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE cat_pregunta(
	...
	i_pregunta_tipo_pregunta 		TINYINT(1) 		UNSIGNED NOT NULL 					COMMENT 'Tipo de pregunta',
    ...
    FOREIGN 						KEY(i_pregunta_tipo_pregunta) 
    REFERENCES 						cat_tipo_pregunta(i_tipo_pregunta)
